...
public class gui extends JFrame{
	...
	private void initialize(String nom) {
		...
		btnNewButton_1.setBounds(419, 346, 154, 25);
		btnNewButton_1.addActionListener(new ActionAnalyser());
		getFrmFileAnalysateur().getContentPane().add(btnNewButton_1);
		
		JTextPane txtpnChooseYourFile = new JTextPane();
		txtpnChooseYourFile.setText("Choose your file to Analyse");
		txtpnChooseYourFile.setBounds(39, 8, 240, 21);
		getFrmFileAnalysateur().getContentPane().add(txtpnChooseYourFile);
		
		JButton btnChoose = new JButton("Choose");
		btnChoose.setBounds(291, 4, 128, 25);
		btnChoose.addActionListener(new ActionChooser());
		getFrmFileAnalysateur().getContentPane().add(btnChoose);
		
		JTextPane txtpnSelectionnedFile = new JTextPane();
		txtpnSelectionnedFile.setText("Selectionned file: ");
		txtpnSelectionnedFile.setBounds(39, 33, 114, 21);
		getFrmFileAnalysateur().getContentPane().add(txtpnSelectionnedFile);
		
		textField_1 = new JTextField();
		textField_1.setBounds(158, 33, 128, 19);
		textField_1.setColumns(10);
		getFrmFileAnalysateur().getContentPane().add(textField_1);
		
		JButton btnNewButton_2 = new JButton("Choose");
		btnNewButton_2.setBounds(178, 292, 23, 25);
		...
		txtpnChoiseAFile.setBounds(12, 281, 154, 36);
		getFrmFileAnalysateur().getContentPane().add(txtpnChoiseAFile);
		
		JTextPane textPane = new JTextPane();
		textPane.setText("Selectionned file: ");
		textPane.setBounds(12, 329, 114, 21);
		getFrmFileAnalysateur().getContentPane().add(textPane);
		
		textField = new JTextField();
		
		textField.setColumns(10);
		textField.setBounds(127, 330, 58, 19);
		...
		btnFastAnalyse.setBounds(419, 304, 154, 25);
